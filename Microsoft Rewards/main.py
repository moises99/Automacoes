...
link_pagina = "https://rewards.bing.com/dashboard"
xpath_pontos = "//p[@class='text-pageHeader']"
xpath_membro = "//span[@class='font-semibold']"
msn_news_home = 'https://www.bing.com/news/?form=ml11z9&crea=ml11z9&wt.mc_id=ml11z9&rnoreward=1&rnoreward=1'

pontos_atuais = verifica_pontos(link_pagina , xpath_pontos)
pontos_membro = verifica_membro(link_pagina , xpath_membro)
...
try:
    ...
    for pos,titulo in enumerate(titulo_noticia):
        ...
        if pos == 20:
            pontos_atuallizados = pontos_atuais = verifica_pontos(link_pagina , xpath_pontos)
