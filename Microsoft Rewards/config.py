...
XPATH_PAGINA = {
    ...
    "definidos_diariamente"     : "//p[@class='text-metadata text-fgCtrlOnImage']",
    "ganhe_mais" : "//span[@class='relative px-paddingCtrlTextSide inline-flex items-center pt-paddingCtrlLgTextTop pb-paddingCtrlLgTextBottom gap-gapBetweenContentXSmall']",
    "continue_ganhando"         : "//p[@class='text-metadata text-fgCtrlOnImage']",
    }
